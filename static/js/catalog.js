...
catalog.init = function() {
  ...
  catalogCellTemplate += '<span class="lockIndicator" title="ロックされた"></span> ';
  catalogCellTemplate += '<span class="pinIndicator" title="粘着性"></span> ';
  catalogCellTemplate += '<span class="cyclicIndicator" title="循環スレッド"></span> ';
  catalogCellTemplate += '<span class="bumpLockIndicator" title="レイズロック"></span>';
